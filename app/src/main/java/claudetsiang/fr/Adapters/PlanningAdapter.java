...
public class PlanningAdapter extends RecyclerView.Adapter<PlanningAdapter.MyViewHolder>{
    ...
    public PlanningAdapter(Context context, ArrayList<PlanningModel> arrayList, RecyclerViewClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        TimeAdapter timeAdapter = new TimeAdapter(context.getApplicationContext(), arrayListTimeData);
        holder.recycler_view_time.setAdapter(timeAdapter);
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            /*time_view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    clickListener.onViewButtonClick(getAdapterPosition());
                }
            });*/
